...
def main():
    ...
    all_dataframes_merged['image_url'] = all_dataframes_merged['img_id'].apply(lambda x: f"https://github.com/yonatanbitton/EvalGQAContrastSets/blob/main/images/{x}.png?raw=true")
